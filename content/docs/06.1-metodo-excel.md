---
title: "6.1. Opção 1: Fórmula Excel/Calc"
weight: 61
bookToc: true
---

## **6.4.1 OPÇÃO 1: Fórmula Excel/Calc para POINT/MULTIPOINT (Automática)** 🌟
...
1. **Certifique-se** de que você já preencheu as 4 colunas de coordenadas (conforme [Seção 6.3.D]({{< relref "06-preparacao-dados#d-adicionar-colunas-de-coordenadas" >}})):
...
**Para geometrias precisas (LineString/Polygon seguindo traçado), use [Opção 3 (QGIS Desenho Manual)]({{< relref "06.3-metodo-qgis" >}}).**

**4. Separador Decimal:**
- A fórmula gera WKT com ponto (.) como separador
- Se você vê vírgulas no WKT, revise a [Seção 6.3.D]({{< relref "06-preparacao-dados#d-adicionar-colunas-de-coordenadas" >}}) sobre formatação de coordenadas
